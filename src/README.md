...
`models/`; provider-neutral Live and context-cache contracts stay in their
owning feature directories. Modules that merely emit telemetry stay with the
feature whose lifecycle they implement.
